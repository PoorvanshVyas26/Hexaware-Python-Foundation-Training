     ...
     def main_menu(self):
          ...
          while True:
               print(
                    ...
                    2. Update the status of an incident (Open/Closed/Under Investigation)
                    3. Get a list of incidents within a date range
                    4. Search for incidents based on incident type 
                    5. Create report of an incident 
                    6. Create a new case 
               ...
               choice = int(input("Please choose from the above options (0-9): "))
